...
public class ImageMerge {
    ...
    public static void imageMargeTest() {
        ...
        String saveFilePath = "E:\\resource\\test\\1.jpg";
        String divingPath = "E:\\resource\\test\\2.jpg";
        String margeImagePath = "E:\\resource\\test\\margeNew.jpg";
        try {
            // 读取待合并的文件
